...
namespace UCT.Models
{
    public class ExcelReportGenerator
    {
        ...
        public ExcelReportGenerator(string programName, string generatorUserName)
        {
        ...
        public byte[] GenerateLearningActivityReport(List<LearningActivity> programLearningActivities)
        {
        ...
        // Creates an Document instance and adds its children.
        public byte[] GenerateCompetencyLearningActivitiesReport(List<LearningGoal> learningGoals, List<LearningActivity> learningActivities, List<CompetencyLearningActivity> competencyLearningActivities)
        {
            byte[] reportBytes = null;
            using (MemoryStream stream = new MemoryStream())
            {
                using (SpreadsheetDocument package = SpreadsheetDocument.Create(stream, SpreadsheetDocumentType.Workbook))
                {
                    CreateCompetencyLearningActivityReportParts(package, learningGoals, learningActivities, competencyLearningActivities);
                }
        ...
        private void CreateLearningActivityReportParts(SpreadsheetDocument document, List<LearningActivity> programLearningActivities)
        {
        ...
        private void GenerateLearningActivityReportSharedStringTablePart1Content(SharedStringTablePart sharedStringTablePart1, List<LearningActivity> programLearningActivities)
        {
        ...
        private void GenerateLearningActivityReportWorksheetPart1Content(WorksheetPart worksheetPart1, List<LearningActivity> programLearningActivities)
        {
        ...
        // Adds child parts and generates content of the specified part.
        private void CreateCompetencyLearningActivityReportParts(SpreadsheetDocument document, List<LearningGoal> learningGoals, List<LearningActivity> programLearningActivities, List<CompetencyLearningActivity> competencyLearningActivities)
        {
            WorkbookPart workbookPart1 = document.AddWorkbookPart();
            ...
            GenerateCompetencyLearningActivitySharedStringTablePart1Content(sharedStringTablePart1, learningGoals, programLearningActivities);
        ...
        // Generates content of sharedStringTablePart1.
        private void GenerateCompetencyLearningActivitySharedStringTablePart1Content(SharedStringTablePart sharedStringTablePart1, List<LearningGoal> learningGoals, List<LearningActivity> programLearningActivities)
        {
            ...
            foreach (LearningGoal learningGoal in learningGoals)
            {
                ...
                foreach (Competency competency in learningGoal.Competencies)
                {
                    ...
                    {
                        index = AddSharedString(sharedStringTable1, descriptor.DescriptorNumber).Value;
        ...
        // Generates content of worksheetPart1.
        private void GenerateCompetencyLearningActivityWorksheetPart1Content(WorksheetPart worksheetPart1, List<LearningGoal> learningGoals, List<LearningActivity> programLearningActivities, List<CompetencyLearningActivity> competencyLearningActivities)
        {
            ...
            foreach (LearningActivity learningActivity in programLearningActivities)
            {
                ...
                cellValue.Text = learningActivity.LearningActivityNumber;
        ...
        private void GenerateCompetencyLearningActivityWorksheetPart2Content(WorksheetPart worksheetPart2, List<LearningActivity> programLearningActivities)
        {
        ...
        private void AddLearningActivitiesUniqueStrings(SharedStringTable sharedStringTable1, List<LearningActivity> programLearningActivities)
        {
            foreach (LearningActivity learningActivity in programLearningActivities)
            {
